...
## v2.0.0 store submission candidate

Version source of truth: `extension/manifest.json` and `package.json`, both exactly `2.0.0`.

Store upload files:

- Chrome: `dist/chat-exporter-by-tom-raz-2.0.0-chrome.zip`
- Microsoft Edge: `dist/chat-exporter-by-tom-raz-2.0.0-edge.zip`
- Firefox: `dist/chat-exporter-by-tom-raz-2.0.0-firefox.zip`
...
- [ ] The release-readiness output says `Chat Exporter 2.0.0` and prints three hashes.
- [ ] `dist/SHA256SUMS-2.0.0.txt` matches those exact ZIPs.
...
- [ ] Grok and Mistral remain labelled Beta in the extension, site and store copy.
...
- [ ] The dashboard shows version `2.0.0` before final submission.
- [ ] After store acceptance, update the changelog state from “store submission candidate” to “released,” commit the final release record and tag `v2.0.0`.
