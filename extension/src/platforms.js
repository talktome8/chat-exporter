(function exposePlatforms(global) {
  ...
  const platforms = [
    ...
    },
    {
      ...
      turns: ['article[aria-label="You" i]', 'article[aria-label="Grok" i]', '[data-message-author-role]', '[data-role="user"]', '[data-role="assistant"]', '[data-testid="conversation-turn-user"]', '[data-testid="conversation-turn-assistant"]', '[data-testid="user-message"]', '[data-testid="assistant-message"]', '.message-bubble'],
      ...
      model: ['[data-testid*="model"]', 'button[aria-label*="model" i]'],
      composer: ['[contenteditable="true"][role="textbox"]', 'form:has(textarea)', '[contenteditable="true"]', 'textarea']
    }
  ];
