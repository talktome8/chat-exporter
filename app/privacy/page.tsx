    ...
    <main className="legal-page">
      <div className="legal-shell">
        ...
        <div lang="he" dir="rtl" className="hebrew-policy">
          ...
          <section><h2>הרשאות</h2><p><code>activeTab</code> תומכת בייצוא מהחלון הרגיל, <code>scripting</code> מריצה את מנגנון החילוץ וה־widget המצורפים לחבילה, ו־<code>storage</code> שומרת הגדרות מקומיות. גישת האתרים הנדרשת מוגבלת לדומיינים המפורטים של ChatGPT, Claude, Gemini, Copilot, Perplexity, Grok ו־Mistral; אין גישה כללית לאתרים אחרים.</p></section>
